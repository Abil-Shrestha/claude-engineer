...
use forgeline_config::Check;
use forgeline_core::{CheckResult, RunSpec, TaskSpec};

/// Instructions appended to the runtime's own system prompt for every
/// implementer session.
pub const IMPLEMENTER_SYSTEM: &str = "You are one agent in a Forgeline software factory. \
...
a state where the project builds and its tests pass. Forgeline commits your work, verifies it and \
...
pub fn task_prompt(
    ...
    if !checks.is_empty() {
        out.push_str(
            "## How your work is verified\n\nWhen you finish, Forgeline runs these commands in your \
