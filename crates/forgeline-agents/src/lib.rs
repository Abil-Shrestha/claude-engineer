//! Agent runtimes.
//!
//! Forgeline drives existing coding agents (Claude Code, Codex, ACP agents…)
...
pub use forgeline_core::AgentEvent;
...
pub struct StartRequest {
    ...
    /// Session id chosen by Forgeline, so it never has to be discovered.
...
pub struct AgentCapabilities {
    ...
    pub resume: bool,
    pub interrupt: bool,
    /// Tool permission prompts are routed to Forgeline.
